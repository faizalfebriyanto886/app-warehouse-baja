...
import 'package:sologwarehouseapp/core/controllers/main_pages/supervisor/good_receiving/form/edit/supervisor_edit_item_receiving_controller.dart';
import 'package:sologwarehouseapp/static/color_app.dart';
import 'package:sologwarehouseapp/widgets/app_bar.dart';

class SupervisorEditItemReceivingView extends StatelessWidget {
  final controller = Get.put(SupervisorEditItemReceivingController());
  @override
  Widget build(BuildContext context) {
    return GetBuilder<SupervisorEditItemReceivingController>(
      builder: (_) {
        return Scaffold(
